...
class AdItemsControllerTest < ActionController::TestCase
  ...
  test "should create ad_item" do
    assert_difference('AdItem.count') do
      post :create, ad_item: { ad_banner_id: @ad_item.ad_banner_id, image: @ad_item.image, name: @ad_item.name, selected: @ad_item.selected }
    end
  ...
  test "should update ad_item" do
    patch :update, id: @ad_item, ad_item: { ad_banner_id: @ad_item.ad_banner_id, image: @ad_item.image, name: @ad_item.name, selected: @ad_item.selected }
    assert_redirected_to ad_item_path(assigns(:ad_item))
  end
